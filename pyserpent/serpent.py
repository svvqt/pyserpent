...
## Updated and adapted by: Konstantin Vitkovskii <kon.vitkovskii@gmail.com>, 2026.
##
## Copyright Notice
## ================
##
...
key_sboxes = (key_sbox0, key_sbox1, key_sbox2, key_sbox3, key_sbox4, key_sbox5, key_sbox6, key_sbox7)
...
def set_key(l_key, key, key_len):
    ...
    for j in range(32):
        ...
        key_sbox_func = key_sboxes[j % 8]
        key[4*j+8], key[4*j+9], key[4*j+10], key[4*j+11] = key_sbox_func(a, b, c, d)
